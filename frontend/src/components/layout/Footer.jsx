        ...
        <div className="grid grid-cols-1 md:grid-cols-4 border-b-4 border-black">
          ...
          <div className="p-8">
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3 bg-black text-white p-2 text-[10px] font-black uppercase tracking-widest break-all">
                <Mail className="h-4 w-4 shrink-0" strokeWidth={3} />
                nussipalmat@gmail.com
              </li>
              <li className="flex items-center gap-3 border-2 border-black p-2 text-[10px] font-black uppercase tracking-widest">
                <Phone className="h-4 w-4 shrink-0" strokeWidth={3} />
                +7 747 116 3647
              </li>
